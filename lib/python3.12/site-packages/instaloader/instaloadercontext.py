...
class InstaloaderContext:
    ...
    def mod_get_json(self, path: str, params: Dict[str, Any], host: str = 'www.instagram.com',
                 session: Optional[requests.Session] = None, _attempt=1,
                 response_headers: Optional[Dict[str, Any]] = None,
                 use_post: bool = False) -> str:
        base_url = 'https://{0}/{1}'.format(host, path)
        # 2. Encode the params dictionary into a query string
        query_string = urllib.parse.urlencode(params)

        # 3. Combine them to get the final URL
